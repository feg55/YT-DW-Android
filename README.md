...
Готовые сборки публикуются в разделе [Releases](https://github.com/feg55/YT-DW-Android/releases). Для большинства современных телефонов подходит APK `arm64-v8a`; `armeabi-v7a` нужен старым 32-битным устройствам, `x86_64` — эмуляторам. Универсальный APK работает на всех поддерживаемых архитектурах, но заметно больше.
